Contributing to GCX Core
============================

The GCX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GCX Core project, and is not to be
confused with overall GCX Network Protocol consensus changes.

Whether a pull request is merged into GCX Core rests with the project merge
...
Patches that change GCX consensus rules are considerably more involved than
...
Where a patch set proposes to change the GCX consensus, it must have been
...
The project leader is the release manager for each GCX Core release.
