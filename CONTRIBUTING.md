Contributing to GCXX Core
============================

The GCXX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GCXX Core project, and is not to be
confused with overall GCXX Network Protocol consensus changes.

Whether a pull request is merged into GCXX Core rests with the project merge
...
Patches that change GCXX consensus rules are considerably more involved than
...
Where a patch set proposes to change the GCXX consensus, it must have been
...
The project leader is the release manager for each GCXX Core release.
