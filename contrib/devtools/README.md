...
shamimiceewu025/GCX repository.
...
Setup
---------
Configuring the github-merge tool for the GCX repository is done in the following way:

    git config githubmerge.repository shamimiceewu025/GCX
...
A script to optimize png files in the GCX
