...
headers and its libLTO.so rather than those from llvmgcxc, as it was
...
- **TODO** The Apple keyholder uses this unsigned app to create a detached signature,
  using the script that is also included there. Detached signatures are available from this [repository](https://github.com/shamimiceewu025/gcx-detached-sigs).
