...
*Setup instructions for a gitian build of GCX using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the GCX
...
To build GCX (for Linux, OSX and Windows) just follow the steps under 'perform
