...
GCX now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ GCX, _12_ times over the course of a year totaling _24000_ GCX.
...
When block `1000000` is reached you'll receive a payment for `1200` GCX.
