...
In order to support loading of multiple wallets in gcx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is gcx.cpp.
...
Changes to gcx.cpp
----------------------
gcx.cpp is the entry point into gcx-qt, and as such, will require some minor modifications to provide hooks for
