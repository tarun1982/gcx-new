...
* Update translations (ping Fuzzbawls on Slack) see [translation_process.md](https://github.com/shamimiceewu025/GCXX/blob/master/doc/translation_process.md#synchronising-translations).
...
### GCXX maintainers/release engineers, suggestion for writing release notes
...
### Build and sign GCXX Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit gcx=v${VERSION} ../gcx/contrib/gitian-descriptors/gitian-osx.yml
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/shamimiceewu025/GCXX/releases/new) with a link to the archived release notes.
