...
#   c) node1 mines 32 blocks, so now node 0 has 60001GCX, node 1 has 4250GCX, node2 has none.
#   d) node0 sends 601 GCX to node2, in two transactions (301 GCX, then 300 GCX).
