...
static Checkpoints::MapCheckpoints mapCheckpoints =
        boost::assign::map_list_of
                (0, uint256("0x00000f07db1386d8a7689101bf17569a8afc0d15f3335b6d76415bb57ba801f5"));
...
public:
    CMainParams()
    {
        ...
        nLastPOWBlock = 300021;
        nModifierUpdateBlock = 615800;
        nZerocoinStartHeight = 190;
        nZerocoinStartTime = 1538214600; // October 17, 2017 4:30:00 AM
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "1st March, gcx coin Publish";
        ...
        genesis.nNonce = 3783826;
						
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000f07db1386d8a7689101bf17569a8afc0d15f3335b6d76415bb57ba801f5"));
        assert(genesis.hashMerkleRoot == uint256("0xbe8ccf73eda7f6afe6881499468a58cf3f81d196f4e9f5e6bf74b7ca654ef2e6"));
...
public:
    CTestNetParams()
    {
        ...
        genesis.nNonce = 649991;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
				
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000009b62a07fc1dcaec0578de9304923bde2cbe1d184828fa8d62fac0f5c50f"));
...
public:
    CRegTestParams()
    {
        ...
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 4132;
        assert(hashGenesisBlock == uint256("0x0a5bef377d6da34cf221497b28853629505743ab7742bb0d9bdc4e178c434269"));
