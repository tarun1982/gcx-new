                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GCX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GCX address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GCX Core"), this);
    aboutAction->setStatusTip(tr("Show information about GCX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GCX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GCX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GCX addresses"));
    ...
    openAction->setStatusTip(tr("Open a GCX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GCX Core help message to get a list with possible GCX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GCX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GCX network", "", count));
}
...
{
    QString strTitle = tr("GCX Core"); // default title
