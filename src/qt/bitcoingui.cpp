                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("GCXX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a GCXX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gcx: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zGCX"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About GCXX Core"), this);
    aboutAction->setStatusTip(tr("Show information about GCXX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for GCXX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GCXX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GCXX addresses"));
    ...
    openAction->setStatusTip(tr("Open a GCXX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the GCXX Core help message to get a list with possible GCXX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("GCXX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GCXX network", "", count));
}
...
{
    QString strTitle = tr("GCXX Core"); // default title
