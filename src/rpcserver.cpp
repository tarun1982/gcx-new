...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GCXX features */
        {"gcx", "masternode", &masternode, true, true, false},
        {"gcx", "listmasternodes", &listmasternodes, true, true, false},
        {"gcx", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gcx", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gcx", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gcx", "masternodedebug", &masternodedebug, true, true, false},
        {"gcx", "startmasternode", &startmasternode, true, true, false},
        {"gcx", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gcx", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gcx", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gcx", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gcx", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gcx", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gcx", "mnbudget", &mnbudget, true, true, false},
        {"gcx", "preparebudget", &preparebudget, true, true, false},
        {"gcx", "submitbudget", &submitbudget, true, true, false},
        {"gcx", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gcx", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gcx", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gcx", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gcx", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gcx", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gcx", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gcx", "checkbudgets", &checkbudgets, true, true, false},
        {"gcx", "mnsync", &mnsync, true, true, false},
        {"gcx", "spork", &spork, true, true, false},
        {"gcx", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"gcx", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use gcxd, or the -server option to gcx-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> gcx-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2132/\n";
}
