...
void test_ecdsa_edge_cases(void) {
    ...
    {
        /* (1,1) encoded in DER. */
        unsigned char sigcxder[8] = {0x30, 0x06, 0x02, 0x01, 0x01, 0x02, 0x01, 0x01};
        unsigned char sigcx64[64] = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        ...
        int pubkeyclen = 65;
        CHECK(secp256k1_ecdsa_recover_compact(msg32, 32, sigcx64, pubkeyc, &pubkeyclen, 0, 0) == 1);
        CHECK(secp256k1_ecdsa_verify(msg32, 32, sigcxder, sizeof(sigcxder), pubkeyc, pubkeyclen) == 1);
        sigcxder[4] = 0;
        sigcx64[31] = 0;
        CHECK(secp256k1_ecdsa_recover_compact(msg32, 32, sigcx64, pubkeyb, &pubkeyblen, 1, 0) == 0);
        CHECK(secp256k1_ecdsa_verify(msg32, 32, sigcxder, sizeof(sigcxder), pubkeyc, pubkeyclen) == 0);
        sigcxder[4] = 1;
        sigcxder[7] = 0;
        sigcx64[31] = 1;
        sigcx64[63] = 0;
