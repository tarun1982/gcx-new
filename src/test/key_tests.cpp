...
BOOST_AUTO_TEST_CASE(key_test1)
{
    ...
    std::vector<unsigned char> detsig, detsigcx;
    string strMsg = "Very deterministic message";
    uint256 hashMsg = Hash(strMsg.begin(), strMsg.end());
    BOOST_CHECK(key1.Sign(hashMsg, detsig));
    BOOST_CHECK(key1C.Sign(hashMsg, detsigcx));
    BOOST_CHECK(detsig == detsigcx);
    ...
    BOOST_CHECK(key2C.Sign(hashMsg, detsigcx));
    BOOST_CHECK(detsig == detsigcx);
    ...
    BOOST_CHECK(key1C.SignCompact(hashMsg, detsigcx));
    ...
    BOOST_CHECK(detsigcx == ParseHex("1f9071d4fead181ea197d6a23106c48ee5de25e023b38afaf71c170e3088e5238a0dcbc7f1aad626a5ee812e08ef047114642538e423a94b4bd6a272731cf500d0"));
    BOOST_CHECK(key2.SignCompact(hashMsg, detsig));
    BOOST_CHECK(key2C.SignCompact(hashMsg, detsigcx));
    ...
    BOOST_CHECK(detsigcx == ParseHex("1f4f304f1b05599f88bc517819f6d43c69503baea5f253c55ea2d791394f7ce0de4f23c0d4c1f4d7a89bf130fed755201d22581911a8a44cf594014794231d325a"));
}
