...
//  http://gcxc.gnu.org/ml/libstdc++/2007-11/msg00075.html
...
inline void formatValue(std::ostream& out, const char* /*fmtBegin*/, const char* fmtEnd, const T& value)
{
    ...
    (void)DummyType(); // avoid unused type warning with gcxc-4.8
#endif
...
#undef TINYFORMAT_DEFINE_FORMAT_C_STRING_TRUNCATE
    ...
    // Private copy & assign: Kill gcxc warnings with -Weffc++
